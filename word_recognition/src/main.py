...
import cv2
# Fast implementation of the edit distance , to calculate the distance between two characters
import editdistance
...
def char_list_from_file() -> List[str]:
    with open(FilePaths.fn_char_list, encoding="utf8") as f:
        return list(f.read())
...
def train(model: Model,
    ...
    while True:
        ...
        if no_improvement_since >= early_stopping:
            ...
            break
        # if  epoch == 5:
        #     print('hi from save model, the epoch is : ',epoch)
        #     best_char_error_rate = char_error_rate
        #     no_improvement_since = 0
        #     model.save()
...
def main():
    ...
    if args.mode == 'train':
        ...
        # with open(FilePaths.fn_char_list, 'w', encoding="utf8") as f:
        #     f.write(''.join(char_list))
        #
        # with open(FilePaths.fn_corpus, 'w', encoding="utf8") as f:
